...
import 'package:registration_flutter/result.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Registration Page'),
    );
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  const Padding(
                      padding: EdgeInsets.all(5), child: Text("Выберите страну")),
                  Padding(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Text("Включить вакансии из других стран"),
                    Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      width: 400,
                      //color: Colors.yellow,
                      child: const Text("Расскажите о себе"),
                    ),
                    TextField(
